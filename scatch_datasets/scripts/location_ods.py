...
# add the reservoir correction for the marine curve
...
# also do the same for mixed curves

sl_data3.loc[sl_data3['Curve'].str.contains("mixed", na=False), 'Reservoir_'] = sl_data3['delta_r']
sl_data3.loc[sl_data3['Curve'].str.contains("mixed", na=False), 'Reservoi_1'] = sl_data3['uncertaint']
